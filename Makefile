...
gen-l10n:
	dart run easy_localization:generate -S "assets/translations" -O "lib/core/generated/localizations"

## Generate localization keys
gen-l10n-keys:
	dart run easy_localization:generate -S "assets/translations" -O "lib/core/generated/localizations" -f keys -o "locale_keys.g.dart"
